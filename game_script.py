...
console.print(text_assets.hangman_art)
    ...
    if is_english:
        ...
        if menu_choice == 2:
            ...
            console.print("Manual:"
                  "\n")
            console.print("Hanging man is based on the idea of having to guess a word, from which you only know the number\n"
        ...
        if menu_choice == 2:
            ...
            console.print("Galgenmännchen basiert auf der Idee, ein Wort erraten zu müssen, von dem du anfangs nur die Anzahl\n"
        ...
        if menu_choice == 4:
            # display the credits
            console.print("Erstellt von Marty Lauterbach als ein Projekt für eine Vorlesung in den Monaten Maerz-Juni 2023\n"
...
if is_english:
    ...
    console.print("Du wachst auf und findest einen riesigen, schattenhaften Riesen vor dir stehen, der über dir aufragt.\n"
...
if first_choice == 2:  # the route of being challenged with a word
    ...
    if strategy_value == 3:
        ...
        if own_dictionaries == 0 or value_if_own_dict == 2:
            console.print("--------------------------------------------------")
            if is_english:
                console.print("If you fly high, you fall deep, foolish Ikarus.\n")
                console.print("I am a villain, and yet I like to play fair. Which language will you write your "
                      "word in? This is my hellish landscape, so these are my rules:\n"
                      "english (1) or german (2)")
            else:
                console.print("Wenn du hoch fliegst, fällst du tief, törichter Ikarus.\n")
                console.print(
...
if who_plays == "Player":
    ...
    if is_english:
        console.print("The letter you wish to guess has {} letter´s... do with this Information what you like.\n".format(
            len(secret_word)))
    else:
        console.print("Der gesuchte Buchstabe hat {} Buchstaben... mache mit dieser Information, was du willst.\n".format(
            len(secret_word)))
    ...
    while remaining_attempts > 0 and len(guessed_letters) < length_of_secret_word:
        ...
        console.print(funcs.get_hangman_stage(remaining_attempts))
    ...
    if strategy_value == 3:
        ...
        while remaining_attempts > 0 and len(guessed_letters) < length_of_secret_word:
            ...
            if remaining_attempts > 0:
                ...
                if is_english:
                    console.print("Jeff, with last breath: Why....Please... u should have use a harder woooooordddd.....")
                else:
