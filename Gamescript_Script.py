...
button_layout_rect = pygame.Rect(0, 0, 70, 20)
button_layout_rect_long = pygame.Rect(0, 0, 50, 20)
...
# text_window = pygame_gui.elements.UIWindow(relative_rect=pygame.Rect((350, 275), (100, 50)),
#                                           manager=manager)
...
while is_running:
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            print("Game will be shutdown / Spiel wird geschlossen")
            time.sleep(5)
            is_running = False
